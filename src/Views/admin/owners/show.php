<div class="bg-white p-6 rounded-xl shadow-lg">
    <div class="flex justify-between items-center mb-6">
        <h3 class="text-xl font-bold text-construction-black">Détails du propriétaire</h3>
        <a href="/agent/owners" class="btn-secondary px-4 py-2 rounded-lg">Retour à la liste</a>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            <p class="text-sm font-medium text-gray-600">Prénom</p>
            <p class="text-lg font-semibold text-construction-black">Jean</p>
        </div>
        <div>
            <p class="text-sm font-medium text-gray-600">Nom</p>
            <p class="text-lg font-semibold text-construction-black">Dupont</p>
        </div>
        <div>
            <p class="text-sm font-medium text-gray-600">Email</p>
            <p class="text-lg font-semibold text-construction-black">jean.dupont@email.com</p>
        </div>
        <div>
            <p class="text-sm font-medium text-gray-600">Téléphone</p>
            <p class="text-lg font-semibold text-construction-black">+33 6 23 45 67 89</p>
        </div>
        <div>
    ...
    <div class="mt-6 flex justify-end space-x-3">
        <a href="/agent/owners/edit/1" class="btn-primary px-4 py-2 rounded-lg">Modifier</a>
