...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form id="building-form" method="POST" action="/buildings/update/<?= $id ?>" enctype="multipart/form-data" class="space-y-6" novalidate>
            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token) ?>">
            <input type="hidden" name="id" value="<?= htmlspecialchars($building->getId()) ?>">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                id="name"
                                name="name"
                                value="<?= htmlspecialchars($building->getName()) ?>"
                                required
                                minlength="3"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                id="city"
                                name="city"
                                value="<?= htmlspecialchars($building->getCity()) ?>"
                                required
                                class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-construction-yellow focus:border-transparent"
                                placeholder="Ville"
                            >
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                id="neighborhood"
                                name="neighborhood"
                                value="<?= htmlspecialchars($building->getNeighborhood()) ?>"
                                class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-construction-yellow focus:border-transparent"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                id="country"
                                name="country"
                                value="<?= htmlspecialchars($building->getCountry()) ?>"
                                required
                                class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-construction-yellow focus:border-transparent"
                                placeholder="Pays"
                            >
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                id="floors"
                                name="floors"
                                value="<?= htmlspecialchars($building->getFloors()) ?>"
                                required
                                min="0"
                                class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-construction-yellow focus:border-transparent"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                value="<?= htmlspecialchars($building->getApartmentCount()) ?>"
                                required
                                min="0"
                                class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-construction-yellow focus:border-transparent"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                name="land_area"
                                step="0.01"
                                value="<?= htmlspecialchars($building->getLandArea()) ?>"
                                min="0"
                                class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-construction-yellow focus:border-transparent"
                    ...
                    <div>
                        ...
                        <select id="parking" name="parking" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-construction-yellow bg-white">
                            ...
                            <?php foreach ($parkingOptions as $value => $label): ?>
                                <option value="<?= htmlspecialchars($value) ?>" <?= $building->getParking() === $value ? 'selected' : '' ?>>
                            ...
                            >
                                ...
                                <?php if (!empty($buildingTypes)): ?>
                                    <?php foreach ($buildingTypes as $type): ?>
                                        <option 
                                            value="<?= $type->getId() ?>"
                                            <?= $building->getTypeId() == $type->getId() ? 'selected' : '' ?>
                                        >
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                id="year_built"
                                name="year_built"
                                value="<?= htmlspecialchars($building->getYearBuilt()) ?>"
                                min="1800"
                                max="<?= date('Y') + 1 ?>"
                                class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-construction-yellow focus:border-transparent"
                                placeholder="Année"
                            ...
                            >
                                ...
                                <?php foreach ($allowedStatuses as $status): ?>
                                    <option 
                                        ...
                                        <?= $building->getStatus() === $status ? 'selected' : '' ?>
                                    >
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                name="price"
                                step="0.01"
                                value="<?= htmlspecialchars($building->getPrice()) ?>"
                                min="0"
                                class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-construction-yellow focus:border-transparent"
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    <?php foreach ($agencies as $agency): ?>
                                        <option 
                                            value="<?= $agency->getId() ?>"
                                            <?= $building->getAgencyId() == $agency->getId() ? 'selected' : '' ?>
                                        >
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    <?php foreach ($agents as $agent): ?>
                                        <option 
                                            value="<?= $agent->getId() ?>"
                                            <?= $building->getAgentId() == $agent->getId() ? 'selected' : '' ?>
                                        >
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                <?php foreach ($owners as $owner): ?>
                                    <option 
                                        value="<?= $owner->getId() ?>"
                                        <?= $building->getOwnerId() == $owner->getId() ? 'selected' : '' ?>
                                    >
                        ...
                        <?php if (!empty($images)): ?>
                            <?php foreach ($images as $image): ?>
                                <div class="relative" data-image-id="<?= htmlspecialchars($image->getId()) ?>">
                                    <img src="<?= htmlspecialchars($image->getPath()) ?>" class="w-full h-24 object-cover rounded-lg" alt="Image du bâtiment">
