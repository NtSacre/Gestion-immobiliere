<div class="bg-white p-6 rounded-xl shadow-lg">
    <h3 class="text-xl font-bold text-construction-black mb-6">Modifier un locataire</h3>
    <form action="/agent/tenants/update/1" method="POST" class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" id="phone" name="phone" value="+966" class="mt-1 block w-full p-3 border border-gray-300 rounded-lg input-focus" readonly>
            </div>
            <div>
        ...
        <div class="flex justify-end space-x-3">
            ...
            <button type="submit" class="btn-primary px-4 py-2 rounded-lg">Modifier</button>
        </div>
    </form>
</div>