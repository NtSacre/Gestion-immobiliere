<div class="bg-white p-6 rounded-xl shadow-lg">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="/agent/apartments" class="btn-secondary px-12 py-2 rounded-lg">Retour à la liste</a>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            <p class="text-sm font-medium text-gray-600">Numéro</p>
            <p class="text-lg font-semibold text-construction-black">3B</p>
        </div>
        <div>
            <p class="text-sm font-medium text-gray-600">Étage</p>
            <p class="text-lg font-semibold text-construction-black">3</p>
        </div>
        <div>
            <p class="text-sm font-medium text-gray-600">Surface (m²)</p>
            <p class="text-lg font-semibold text-construction-black">75</p>
        </div>
        <div>
            <p class="text-sm font-medium text-gray-600">Nombre de chambres</p>
            <p class="text-lg font-semibold text-construction-black">2</p>
        </div>
        <div>
            <p class="text-sm font-medium text-gray-600">Statut</p>
            <p class="text-lg font-semibold text-construction-black">
                <span class="px-2 py-1 bg-green-100 text-green-700 rounded-full text-sm">Disponible</span>
            </p>
        </div>
        <div>
            <p class="text-sm font-medium text-gray-600">Bâtiment</p>
            <p class="text-lg font-semibold text-construction-black">Résidence Victor Hugo</p>
        </div>
    </div>
    <div class="mt-6 flex justify-end space-x-3">
        <a href="/agent/apartments/edit/1" class="btn-primary px-4 py-2 rounded-lg">Modifier</a>
