...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <h1 class="text-2xl font-bold text-construction-black">Ajouter un appartement</h1>
                </div>
        ...
        <form id="apartment-form" method="POST" action="/apartments/store" enctype="multipart/form-data" class="space-y-6" novalidate>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                id="toilets"
                                name="toilets"
                                value="<?= htmlspecialchars($_POST['toilets'] ?? '') ?>"
                                min="0"
                                class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-construction-yellow focus:border-transparent"
                                placeholder="Ex. 1"
                            >
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                id="living_rooms"
                                name="living_rooms"
                                value="<?= htmlspecialchars($_POST['living_rooms'] ?? '') ?>"
                                min="0"
                                class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-construction-yellow focus:border-transparent"
                                placeholder="Ex. 1"
                            >
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                id="kitchens"
                                name="kitchens"
                                value="<?= htmlspecialchars($_POST['kitchens'] ?? '') ?>"
                                min="0"
                                class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-construction-yellow focus:border-transparent"
                                placeholder="Ex. 1"
                            >
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            >
                                <option value="0" <?= (isset($_POST['has_balcony']) && $_POST['has_balcony'] == '0') ? 'selected' : '' ?>>Non</option>
                                <option value="1" <?= (isset($_POST['has_balcony']) && $_POST['has_balcony'] == '1') ? 'selected' : '' ?>>Oui</option>
                            </select>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                name="charges_amount"
                                step="0.01"
                                value="<?= htmlspecialchars($_POST['charges_amount'] ?? '') ?>"
                                min="0"
                                class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-construction-yellow focus:border-transparent"
                            ...
                            >
                                ...
                                <?php foreach ($buildings as $building): ?>
                                    <option 
                                        ...
                                        <?= (isset($_POST['building_id']) && $_POST['building_id'] == $building->getId()) ? 'selected' : '' ?>
                                    >
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateField(input) {
        ...
        switch (name) {
            ...
            case 'price':
                if (input.value && input.value < 0) {
                    isValid = false;
                    errorMessage = `Le ${name === 'rent_amount' ? 'loyer' : name === 'charges_amount' ? 'montant des charges' : 'prix'} doit être positif.`;
                }
                break;
            case 'building_id':
            case 'owner_id':
    ...
    ['number', 'floor', 'area', 'rooms', 'bedrooms', 'bathrooms', 'toilets', 'living_rooms', 'kitchens', 'rent_amount', 'charges_amount', 'price', 'building_id', 'owner_id', 'type_id', 'status', 'agency_id', 'agent_id'].forEach(name => {
